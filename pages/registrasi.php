                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                      ...
                      ?>
                        <tbody style="background-color:white; color-text:red">
                          ...
                          <td style="color:black"><?php echo $row['level']; ?></td>
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 15px;" href="proses/proses_hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">hapus</a>&nbsp;
                          </td>
                        </tbody>
                        <!-- Modal -->
