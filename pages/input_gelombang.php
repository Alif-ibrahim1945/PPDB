...
<h3 class="page-title"> Gelombang </h3>
</div> 
                    ...
                    <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style=" color:black;"><?php echo $row['gelombang']; ?></td>
                          <td style=" color:black;"><?php echo $row['nominal']; ?></td>
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger mdi mdi-delete" style="font-size: 15px;" href="proses/pros_hapus_gel.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">HAPUS</a>&nbsp;
                          </td>
                        </tbody>
                        <!-- Modal -->
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form class="needs-validation" action="proses/pros_edit_gel.php" method="post">
                                  <div class="row">
                                    <div class="col-md-12 mb-3">
                                      <label class="firstName">Gelombang</label>
                                    ...
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <input type="text" class="form-control" name="harga" id="lastName" placeholder="" value="<?php echo $row['nominal']?>" required="">
