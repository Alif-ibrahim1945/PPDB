        ...
        <ul class="menu">
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="#" class="submenu-link">Data kaos</a>
                    ...
                    <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="color:black"><?php echo $row['ukuran']; ?></td>
                                ...
                                <form class="needs-validation" action="proses/pros_edit_kaos.php" method="post">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                      ...
                                      <select class="costum-select d-block w-100" name="ukuran" id="country" required="">
