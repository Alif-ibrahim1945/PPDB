        ...
        <ul class="menu">
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item  ">
                        <a href="#" class="submenu-link">data pembayaran</a>
                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                      <thead style="background-color:darkblue;color:black">
                        <tr align="center">
                          <th> No Transaksi </th>
                          <th> Tanggal </th>
                          <th> Nama Siswa </th>
                                  ...
                                  <form class="needs-validation" action="proses/pelunasan.php" method="post">
                                    <div class="row">
                                      <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" style="color: white;" name="no_pendaftaran" id="firstName" placeholder="" value="<?php echo $row['no_pendaftaran']; ?>" required="" readonly>
                                      ...
                                      <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" name="tanggal" style="color: white;" id="lastName" placeholder="" value="<?php echo $row['tanggal']; ?>" required="" readonly>
                                      ...
                                      <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" style="color: white;" name="nama_siswa" id="firstName" placeholder="" value="<?php echo $row['nama_siswa'] ?>" required="" readonly>
                                        <div class="invalid-feedback">
                                          Valid first name is required.
                                        </div>
                                      </div>
                                      ...
                                      <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" class="form-control sisa-pembayaran" id="nominal_<?php echo $row['id']; ?>" style="color: white;" name="nominal" placeholder="" value="" required="" readonly>
